...
public enum JwtErrorCode implements BaseErrorCode<JwtException> {
    ...
    INVALID_REFRESH_TOKEN(HttpStatus.BAD_REQUEST, "쿠키에 저장된 리프레쉬 토큰이 유효하지 않습니다."),
    EXPIRED_REFRESH_TOKEN(HttpStatus.UNAUTHORIZED, "리프레쉬 토큰의 유효 기간이 만료되었습니다. 다시 로그인해 주세요."),
