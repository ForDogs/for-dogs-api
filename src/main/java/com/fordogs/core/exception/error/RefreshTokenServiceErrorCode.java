...
public enum RefreshTokenServiceErrorCode implements BaseErrorCode<DomainException> {
    ...
    USER_DISABLED(UserServiceErrorCode.USER_DISABLED.getHttpStatus(), UserServiceErrorCode.USER_DISABLED.getMessage());
